...
const config: configType = {    
    ...
    weightToLooseText: (weight) => `Vous avez environs ${weight} kg à perdre pour avoir un poids normal.`,

    weightToGainText: (weight) => `Vous avez environs ${weight}kg à prendre pour avoir un poids normal.`
