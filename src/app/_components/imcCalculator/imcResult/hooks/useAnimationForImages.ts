...
export default function useAnimationForImages(
    ...
    useEffect(() => {
        ...
        switch (step!.status) {
            case "maigreur":
                setAnimationForImages((prevState) => ({
                    ...prevState,
                    dénutrition: "animate-hide",
                }));
