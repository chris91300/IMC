...
describe("test of ImcForm component", () => {
    ...
    it("should change the weight value when user write a valid weight", async () => {
        ...
        const weightInput90 = await screen.findByRole("spinbutton", {
            name: weightLabelText,
        });
    ...
    it("should show the error message when user write an unvalid weight", async () => {
        ...
        const errorMessage = await screen.findByText(
            "un poids valide svp (ex: 75,2)"
        );
        expect(errorMessage).toBeInTheDocument();

        const weightInput60 = await screen.findByRole("spinbutton", {
            name: weightLabelText,
        });
    ...
    it("should change the tall input value when user write a valid tall", async () => {
        ...
        await user.keyboard((1.8).toString());
        const tallInput180 = await screen.findByRole("spinbutton", {
            name: tallLabelText,
        });

        expect(tallInput180).toHaveValue(1.8);
    });
    ...
    it("should show the error message when user write an unvalid tall", async () => {
        ...
        const tallInput60 = await screen.findByRole("spinbutton", {
            name: tallLabelText,
        });
