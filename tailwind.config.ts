    ...
    theme: {
        extend: {
            ...
            keyframes: ({ theme }) => ({
                ...
                denutritionToMaigreur: {
                    "0%": {
                        ...
                        boxShadow: `${theme("boxShadow.full")} ${theme(
                            "colors.denutrition"
                        )}`,
                    },
                    "100%": {
            ...
            animation: {
                ...
                denutritionToMaigreur:
                    "denutritionToMaigreur 1s linear forwards",
                maigreurToPoidsNormal:
                    "maigreurToPoidsNormal 1s linear forwards",
                poidsNormalToSurpoids:
                    "poidsNormalToSurpoids 1s linear forwards",
                surpoidsToObesiteModeree:
                    "surpoidsToObesiteModeree 1s linear forwards",
                obesiteModereeToObesiteSevere:
                    "obesiteModereeToObesiteSevere 1s linear forwards",
                obesiteSevereToObesiteMorbide:
                    "obesiteSevereToObesiteMorbide 1s linear forwards",
            },
        },
    },
    plugins: [],
